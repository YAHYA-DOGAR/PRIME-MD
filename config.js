...
global.allowJids = process.env.ALLOW_JID || "919382400759@s.whatsapp.net";
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/4696cca453deffefae2f7.jpg";
global.devs = "923135673658";
global.sudo = process.env.SUDO || "919382400759";
global.owner = process.env.OWNER_NUMBER || "919382400759";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "Soumyadip-X😍",
  author: process.env.PACK_AUTHER || "Soumyadip-X",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "Soumyadip-X",
  ownername: process.env.OWNER_NAME || "Soumyadip-X,
  errorChat: process.env.ERROR_CHAT || "919382400759",
  ...
  LANG: (process.env.THEME || "Soumyadip-X").toUpperCase(),
};
global.rank = "updated";
